...
//       querySnapshot.forEach((doc) => {
//         const user = doc.data();
//         if (user?.displayName.toLowerCase().includes(lowercaseUsername)) {
//           users.push(user);
//         }
//         console.log(users);
//       });
  ...
  return (
    <>
      <div className="search">
        ...
        {user && (
          <div
            className="userChat border-b p-1 grid grid-cols-5 h-14 hover:bg-slate-500 transition-all duration-150 cursor-pointer "
            onClick={handleSelect}
          >
            <div className=" col-span-1 flex h-full justify-center items-center">
              <img
